...
public class Main {
	...
	public static void readTextFileUsingScanner() {
		try {
			...
			while (sc.hasNextLine()) {
				...
				if ((STCA[0] != 'O') && (STCA[0] != 'B')
					...
					//load with label
						...
						//System.out.print(l.label.toString());
	 ...
	 * @throws IOException
	 */
	public static void bufferedWritter(String s) throws IOException {
		BufferedWriter writer = new BufferedWriter(new FileWriter(
				"C:\\Users\\zhz10\\labs\\FinalProject\\Assembler\\assembler\\assembler\\src\\assembler\\testResult.txt"));
		writer.write(s);
		writer.close();
	}
